...
function AboutPopup:initText()
	if self.popupName == "bangzhu" then
		local text = {
						"\n 穿越火线之cs逆战射击 \n \n",
						"故事背景:\n",
						"      故事发生在2034年,男主角“杰”收到哥哥的留言,要他代替哥哥去执行一个 \n",
						"艰巨的任务.然而等待他的是哥哥的遇难,上司的背叛。“杰”和他的队友身处极\n",
						"度危险,错综复杂的世界,他们将面对诸多敌人，随时随地准备对抗迎面而来\n",
						"的袭击。\n \n",
						"操作方法:\n",
						"瞄准:滑动屏幕移动准星。\n",
						"射击:点击右下角射击按钮开枪,住按会连续射击。\n",
						"手雷:瞄准敌人后，点击射击上面的手雷按钮。\n",
						"盾牌:点击手雷上方的防爆盾牌图标,可抵挡敌人的攻击,使用盾牌时可以继续\n",
						"攻击。\n",
						"机甲变身:点击屏幕右上的机甲按钮,驾驶机甲,可以免受任何伤害。\n",
						"黄金变身:点击黄金变身,对敌人造成巨大伤害。\n \n",
						"功能界面:\n",
						"点击关卡图标:进入准备界面。\n",
						"武器库:购买各种武器,玩家可以选择2把武器带入战斗。\n",
						"武器升级:花费金币提高武器的属性。\n",
						"镶嵌:为武器镶嵌各种零件,额外提高武器能力,战斗结束后零件消失。\n",
						"商城:花费购买各种道具。\n"
						}
		self.text = "";
