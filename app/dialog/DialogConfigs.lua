...
configs[1]  = {
	level1 = {
		forward = {
			{role = "萝莉", imgname = "role_luoli",msg = "根据可靠的情报，这个仓库里有敌人很重要导弹发射装置和大量的军火。", pos = "right"},
	...
	level3 = {
		forward = {
			...
			{role = "萝莉",imgname = "role_luoli", msg = "收到！", pos = "right"},
	...
	level5 = {
		...
		after = {
			...
			{role = "萝莉",imgname = "role_luoli", msg = "杰，敌人援兵到了，快撤退",  pos = "right"},
		},
	},
}
