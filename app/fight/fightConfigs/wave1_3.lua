...
--enemy的关卡配置                           青铜镶嵌 MP5伤害65  dps大于等于1 怪物数据
local enemys = {
	--普通兵
	{id=1,image="anim_enemy_002",demage=2,hp=327,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=4,
	weak1=3},

	--近战兵
	{id=2,image="jinzhanb",demage=3,hp=982,fireRate=180,fireCd=3,speed=40,scale = 1.6,
	...
	--手雷兵
	{id=6,image="shouleib",demage=0,hp=327,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=5,
	weak1=3},
	--手雷
	...
	weak1=2,    award = 60},
	-- 盾兵
	{id=11,image="dunbing",demage=3,hp=3276,fireRate=240,fireCd=5,speed=35,--scale = 2.0,
