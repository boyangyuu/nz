...
local enemys = {
	...
	--狙击兵      --type = "juji",
	{id=4,image="jujib",demage=25,hp=200000, rollRate=180,rollCd=3,fireRate=2, fireCd = 6,
	weak1=2},

	--盾兵         --type = "jin",
	{id=8,image="dunbing",demage=25,hp=300000,fireRate=180,fireCd=5,speed=35, scale = 2.0 ,
	weak1=2, weak4=4},

	--自爆兵        --type = "bao",
	{id=9,image="zibaob",demage=40,hp=100000,fireRate=30,speed=130,scale = 1.9,
	weak1=2},

	--越野车       type = "jipu" ,
	{id=12,image="yyc",demage=0,hp=300000,walkRate=180,walkCd = 2.0,rollRate=240, rollCd = 1.5, fireRate=6, fireCd=8.0,
	weak1=2,    award = 60},	

	--黑衣忍者兵            冲锋伤害  type = "renzhe",
	{id=17,image="xiaorz",demage=40,hp=200000,walkRate=100,walkCd = 1.0,rollRate=40, rollCd = 1.5,fireRate=180, fireCd=2.0, 
	shanRate = 120, shanCd = 4, chongRate = 120, chongCd = 4, weak1=2},	

	--飞镖
	{id=18,image="feibiao",demage=20,hp=20000}, 

	--BOSS导弹          type = "missile",
	{id=20,image="daodan",demage=25,hp=20000, weak1=1},

	--烟雾导弹           type = "dao_wu",
	{id=22,image="daodan03",demage=25,hp=20000, weak1=1},           --打击者金武平均伤害5558

	--大黑导弹           type = "missile",
	{id=23,image="daodan02",demage=200,hp=50000, weak1=1},

	--BOSS铁球
	{id=24,image="tieqiu",demage= 100,hp=50000, weak1=1},

	--高级召唤医疗兵      type = "yiliao",
	{id=26,image="yiliaob",demage=25,hp=200000,walkRate=180,walkCd=2,rollRate=180,rollCd=3,fireRate=180,fireCd=4,
	weak1=2},

	--蜘蛛网
	{id=27,image="zzw",demage=25,hp=50000},
