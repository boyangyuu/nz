...
local bosses = {
	--第一个出场的boss
	{
		...
		skilltrigger = {   			          --技能触发(可以同时)
			...
			feibiao1 = { 0.99, 0.50,          --暴雨梨花针1
			},
			feibiao2 = { 0.80,                --暴雨梨花针2	
			},							
			zhaohuan = { 0.90, 0.60, 0.30                    --召唤分身
			},                                           
			chongfeng = { 0.95, 0.75,0.65, 0.55, 0.45, 0.35, 0.25, 0.15     --冲锋
			},
		...
		feibiao2 = {
			-- srcPoses = {cc.p(1136/2,640/2), cc.p(1136/2,640/2),cc.p(1136/2,640/2), cc.p(1136/2,640/2), },
			offsetPoses = {
							-- cc.p(-450, 450),cc.p(-300, 300), cc.p(-150, 150), cc.p(0, 0), cc.p(150, -150), cc.p(300, -300),cc.p(450, -450),
			    --             cc.p(450, 450), cc.p(300, 300), cc.p(150, 150),cc.p(0, 0),cc.p(-150, -150), cc.p(-300, -300),cc.p(-450, -450),}
			                cc.p(0, 0),cc.p(-200, 0),cc.p(200, 0),cc.p(-400, 0),cc.p(400, 0),cc.p(-600, 0),cc.p(600, 0),
			                cc.p(0, 0),cc.p(0, 200),cc.p(0, -200),cc.p(0, 400),cc.p(0, -400),cc.p(0, 600),cc.p(0, -600),}
		},
