	...
	--第一个出场的boss
	{
		...
		feibiao2 = {
			...
			offsetPoses = {
			    		...
			    		-- cc.p(450, 450), cc.p(300, 300), cc.p(150, 150),cc.p(0, 0),cc.p(-150, -150), cc.p(-300, -300),cc.p(-450, -450),}
			                cc.p(0, 0),cc.p(-200, -100),cc.p(200, 100),cc.p(-400, 100),cc.p(400, -100),cc.p(-600, 200),cc.p(600, -200),
			                cc.p(0, 0),cc.p(-100, 200),cc.p(100, -200),cc.p(100, 400),cc.p(-100, -400),cc.p(200, 600),cc.p(-200, -600),}
		},
		feibiao3 = {    --srcPoses= 初始位置       --offsetPoses =偏移    --暴雨梨花针3
			srcPoses = {cc.p(1136/2,640/2), cc.p(1136/2,640/2),cc.p(1136/2,640/2), cc.p(1136/2,640/2),
			 		    cc.p(1136/2,640/2), cc.p(1136/2,640/2),cc.p(1136/2,640/2), cc.p(1136/2,640/2),
			 		    cc.p(1136/2,640/2), cc.p(1136/2,640/2),cc.p(1136/2,640/2), cc.p(1136/2,640/2), },   
