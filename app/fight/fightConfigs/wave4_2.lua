...
local enemys = {
	...
	{id=1,image="anim_enemy_002",demage=12,hp=8000,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=4,
	weak1=2, weak4=3},

	--狙击兵      --type = "juji",
	{id=4,image="jujib",demage=18,hp=16000, rollRate=180,rollCd=3,fireRate=6, fireCd = 6,
	weak1=2},
	...
	--盾兵         --type = "jin",
	{id=9,image="dunbing",demage=15,hp=25000,fireRate=180,fireCd=5,speed=35, scale = 1.9,--scale = 3.0,  近战走到屏幕最近放缩比例
	weak1=2},
	...
	--飞机         type = "feiji" ,
	{id=11,image="feiji",demage=0,hp=30000, walkRate=180,walkCd = 2.0,rollRate=120, rollCd = 1.5, fireRate=120, fireCd=3.0,
	weak1=2,    award = 60},
	...
	{id=17,image="xiaorz",demage=15,hp=30000,walkRate=100,walkCd = 1.0,rollRate=40, rollCd = 1.5,fireRate=180, fireCd=3.0, 
