...
local enemys = {
	...
	--狙击兵      --type = "juji",
	{id=4,image="jujib",demage=30,hp=4500, rollRate=180,rollCd=3,fireRate=180, fireCd = 6,
	weak1=3},                                                           

	--导弹兵      --type = "dao",
	{id=5,image="zpbing",demage=0,hp=4500,walkRate=120,walkCd=2,fireRate=240,fireCd=5,
	weak1=2},
	...
	{id=7,image="tufeib",demage=20,hp=1500,walkRate=180,walkCd=2,rollRate=180,rollCd=3,fireRate=180,fireCd=4, weak1=3},

	--被绑架人        --type = "bangren",
	{id=8,image="hs", hp=800, weak1=1},	

	--医疗兵      type = "yiliao",
	{id=10,image="yiliaob",demage=20,hp=1500,walkRate=180,walkCd=2,rollRate=180,rollCd=3,fireRate=180,fireCd=4,
	weak1=2},

	--飞机         type = "feiji" ,
	{id=11,image="feiji",demage=0,hp=7500, walkRate=180,walkCd = 2.0,rollRate=120, rollCd = 1.5, fireRate=180, fireCd=4.0,
	weak1=2,    award = 60},

	--越野车       type = "jipu" ,
	{id=12,image="yyc",demage=0,hp=7500,walkRate=180,walkCd = 2.0,rollRate=240, rollCd = 1.5, fireRate=180, fireCd=4.0,
	weak1=2,    award = 60},

	--忍者兵            冲锋伤害  type = "renzhe",
	{id=17,image="xiaorz",demage=20,hp=4500,walkRate=120,walkCd = 2.0,rollRate=120, rollCd = 1.5,fireRate=180, fireCd=4.0, 
