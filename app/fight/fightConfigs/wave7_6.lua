...
local enemys = {
	...
	--盾兵         --type = "jin",
	{id=8,image="dunbing",demage=30,hp=90000,fireRate=180,fireCd=5,speed=35,
	weak1=2},
	...
	--BOSS铁球
	{id=21,image="tieqiu",demage=35,hp=15000,weak1=1},

	--小蜘蛛   --type = "bao",
	{id=22,image="xiaozz",demage=20,hp=7000, speed=120,
	weak1=1},  
