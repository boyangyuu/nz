...
local enemys = {
	...
	{id=1,image="anim_enemy_002",demage=50,hp=30000,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=4,
	weak1=2},
	...
	--手雷            --missileType = "lei",
	{id=3,image="shoulei",demage=50,hp=9000,
	weak1=1},
	...
	--导弹兵      --type = "dao",
	{id=5,image="zpbing",demage=0,hp=75000,walkRate=120,walkCd=2,fireRate=240,fireCd=5,
	weak1=2},

    --导弹          --missileType = "daodan",
	{id=6,image="daodan",demage=70,hp=9000,
	weak1=1},	

	--近战兵         --type = "jin",          180-- 相对地图的y轴位置       1.7-- 狼牙棒兵 盾兵到身前的比例
	{id=7,image="jinzhanb",demage=50,hp=90000,fireRate=180,fireCd=4,speed=40,
	weak1=2},

	--盾兵         --type = "jin",
	{id=8,image="dunbing",demage=60,hp=120000,fireRate=180,fireCd=5,speed=35,
	weak1=2},

	--自爆兵        --type = "bao",
	{id=9,image="zibaob",demage=50,hp=60000,fireRate=30,speed=120,
	weak1=2},	
	...
	--飞机         type = "feiji" ,
	{id=11,image="feiji",demage=0,hp=300000, walkRate=180,walkCd = 2.0,rollRate=120, rollCd = 1.5, fireRate=180, fireCd=4.0,
	weak1=2,    award = 60},

	--越野车       type = "jipu" ,
	{id=12,image="yyc",demage=0,hp=300000,walkRate=180,walkCd = 2.0,rollRate=240, rollCd = 1.5, fireRate=120, fireCd=3.0,
	weak1=2,    award = 60},
	...
	{id=17,image="xiaorz",demage=80,hp=150000,walkRate=100,walkCd = 1.0,rollRate=40, rollCd = 1.5,fireRate=180, fireCd=2.0, 
	shanRate = 100, shanCd = 4, chongRate = 100, chongCd = 4, 
	weak1=2},	

	--飞镖
	{id=18,image="feibiao",demage=30,hp=18000}, 
	
	--蜘蛛网
	{id=19,image="zzw",demage=20,hp=100000},  

    --BOSS导弹        --missileType = "daodan",
	{id=20,image="daodan",demage=70,hp=6000,
	weak1=1},

	--BOSS铁球
	{id=21,image="tieqiu",demage=70,hp=35000,weak1=1},

	--小蜘蛛   --type = "bao",
	{id=22,image="xiaozz",demage=40,hp=10000, speed=120,
	weak1=1},  
