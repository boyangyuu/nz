...
--enemy的关卡配置                               黄金镶嵌    6星巴雷特1200伤害   1枪  2760         dps大于等于6
local enemys = {
	

	--忍者兵            冲锋伤害  type = "renzhe",
	{id=17,image="xiaorz",demage=24,hp=11000,walkRate=120,walkCd = 2.0,rollRate=120, rollCd = 1.5,fireRate=180, fireCd=4.0, 
