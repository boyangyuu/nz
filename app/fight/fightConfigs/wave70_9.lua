...
local enemys = {
	...
	--手雷兵
	{id=2,image="shouleib",demage=0,hp=880,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=5,
	weak1=2},

	--手雷
	{id=3,image="shoulei",demage=10,hp=440,
	weak1=2},

	--囚犯            type = "taofan_qiu",
	{id=4,image="qiufan",demage=8,hp=3300,
	weak1=2, weak4=3},

	-- 盾兵
	{id=8,image="dunbing",demage=10,hp=9900,fireRate=240,fireCd=5,speed=35,   --scale = 2.0,
