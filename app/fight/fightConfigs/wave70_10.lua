		...
		enemys = {
			{
				...
				property = {
					...
					missileId = 13,
					missileType = "dao_wu",
					missileOffsets = {cc.p(150,-250), cc.p(-150, -150)},	--炮筒位置发出xy轴偏移值,第一个位置右一,第二位置个右二
...
local enemys = {
	...
	--导弹兵      --type = "dao",
	{id=5,image="zpbing",demage=0,hp=3770,walkRate=120,walkCd=2,fireRate=240,fireCd=5,
	weak1=2},

	--导弹          --missileType = "daodan",
	{id=6,image="daodan",demage=15,hp=1253,
	weak1=1},

	--近战兵         --type = "jin",          180-- 相对地图的y轴位置       1.7-- 狼牙棒兵 盾兵到身前的比例
	{id=7,image="jinzhanb",demage=16,hp=4710,fireRate=180,fireCd=4,speed=60,
	weak1=2},

	--越野车       type = "jipu" ,
	{id=12,image="yyc",demage=0,hp=28270,walkRate=180,walkCd = 2.0,rollRate=240, rollCd = 1.5, fireRate=120, fireCd=4.0,
	weak1=3,    award = 60},
