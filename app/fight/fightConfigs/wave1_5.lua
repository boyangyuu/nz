...
local enemys = {
	...
	{id=1,image="anim_enemy_002",demage=6,hp=405,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=4,
	weak1=2},

	--手雷兵      --type = "dao",
	{id=2,image="shouleib",demage=0,hp=405,walkRate=180,walkCd=2,rollRate=180,rollCd=2,fireRate=180,fireCd=5,
	weak1=2},
	...
	--导弹兵      --type = "dao",
	{id=5,image="zpbing",demage=0,hp=540,walkRate=180,walkCd=2,fireRate=180,fireCd=5,
	weak1=2},
