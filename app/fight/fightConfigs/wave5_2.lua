...
local enemys = {
	...
	--盾兵         --type = "jin",
	{id=8,image="dunbing",demage=30,hp=70000,fireRate=180,fireCd=5,speed=40, scale = 1.8 ,
	weak1=2},
	...
	--蜘蛛网
	{id=19,image="zzw",demage=15,hp=30000},  
	...
	--小蜘蛛   --type = "bao",
	{id=21,image="xiaozz",demage=20,hp=7000, speed=120,
	weak1=1},                      
}
